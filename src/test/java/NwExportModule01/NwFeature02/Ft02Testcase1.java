...
package NwExportModule01.NwFeature02;
...
public class Ft02Testcase1 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new MhLoginnPage(driver).username1,"sbasava022@test.com");
        ...
        try
        {
            actions.EnterData(new MhLoginnPage(driver).password2,"Opallll");
